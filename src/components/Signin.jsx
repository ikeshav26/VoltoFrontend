                ...
                <div className='w-full'>
                    <form onSubmit={submitHandler} className='flex flex-col gap-10 justify-center items-center'>
                        <div className='flex flex-col gap-6 justify-center items-center'>
                            <div className='flex flex-col gap-3'>
                                <input
                                    ...
                                    name="username"
                                    required
                                    className="input md:w-[40vw] h-[48px] text-[#0B78D0] bg-[#F2F4F7] font-bold"
                        ...
                        <div className='flex justify-around gap-10 items-center mt-16'>
                            ...
                            <button className='cursor-pointer hover:opacity-70 transition-opacity duration-100'>
