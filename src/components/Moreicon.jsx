    ...
    <div>
      <button className=" cursor-pointer" popoverTarget="popover-1" style={{ anchorName: "--anchor-1" } /* as React.CSSProperties */}>
                                    < svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" >
                                        <path d="M8.75 15C8.75 16.3807 7.63071 17.5 6.25 17.5C4.86929 17.5 3.75 16.3807 3.75 15C3.75 13.6193 4.86929 12.5 6.25 12.5C7.63071 12.5 8.75 13.6193 8.75 15Z" fill="#4A5B68" />
                                        <path d="M17.5 14.9654C17.5 16.3461 16.3807 17.4654 15 17.4654C13.6193 17.4654 12.5 16.3461 12.5 14.9654C12.5 13.5847 13.6193 12.4654 15 12.4654C16.3807 12.4654 17.5 13.5847 17.5 14.9654Z" fill="#4A5B68" />
                                        <path d="M23.7502 17.5C25.1309 17.5 26.2502 16.3807 26.2502 15C26.2502 13.6193 25.1309 12.5 23.7502 12.5C22.3695 12.5 21.2502 13.6193 21.2502 15C21.2502 16.3807 22.3695 17.5 23.7502 17.5Z" fill="#4A5B68" />
                                    </svg >
                                </button>
                                <ul className="dropdown menu w-80 rounded-box bg-white px-7 py-10  shadow-sm flex flex-col gap-4"
                                    popover="auto" id="popover-1" style={{ positionAnchor: "--anchor-1" } /* as React.CSSProperties */}>
                                    <div>
                                        <p className='text-black font-semibold text-[16px]'>Page settings - Welcome to Volto</p>
                                    </div>
                                    <div className='flex flex-col gap-4 '>
                                        <div className='text-black flex justify-between border-b-2 border-[#E4E7ED] pb-1'>
                                            <a>State</a>
                                            <a className='flex items-center gap-1 text-[#0B78D0]'><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9 13.5C11.4853 13.5 13.5 11.4853 13.5 9C13.5 6.51472 11.4853 4.5 9 4.5C6.51472 4.5 4.5 6.51472 4.5 9C4.5 11.4853 6.51472 13.5 9 13.5Z" fill="#0B78D0" />
                                            </svg>
                                        ...
                                        <div className='text-black flex justify-between border-b-2 border-[#E4E7ED] pb-1'>
                                            ...
                                            <a className='flex items-center gap-1 text-[#0B78D0]'><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <select className='w-30'>
                                                    <option className=''>Document</option>
                                                    <option>List</option>
